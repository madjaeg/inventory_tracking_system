...
//If amount is empty, contains not only numbers, or is less than or equal to 0
if ( ($_POST['changeAmount'] == "") || (ctype_alpha($_POST['changeAmount'])) || ($_POST['changeAmount'] <= 0) ){
	$_SESSION['changeAmount_errors'] = true;
	$errorText .= "<br/> - Amount cannot be less than or equal to 0";
}
